...
export default class App extends React.Component {
  ...
  componentDidMount() {
    fetch(`http://api.wunderground.com/api/${apiKey}/forecast/geolookup/conditions/hourly/forecast10day/q/CO/Denver.json`)
    .then( data => data.json() )
    .then( data => {
      console.log(data)
      ...
      this.setState({currentWeather, sevenHour, tenDay});
